...
def send(call):
    ...
    last_message = """Ты уже красавчик раз дошел до сюда - ты уже готов что-то менять!
...
1. Разбирём твой бизнес по полочкам.

2. Найдём якоря, которые тянут вниз.

3. Обсудим, какие инструменты нужно внедрить прямо сейчас.
    
Плюсом расскажу о своей методологии, как оптимизировать бизнес-процессы компании, чтобы расправиться с операционкой и двигаться вперёд! 
